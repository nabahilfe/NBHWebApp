...
public interface AccountingRepository extends ListCrudRepository<AccountingEntry, Long> {
    ...
    @Query("SELECT a FROM AccountingEntry a LEFT JOIN FETCH a.createdBy WHERE YEAR(a.accountingDate) = :year AND a.transactionType = :transactionType ORDER BY a.accountingDate DESC, a.createdAt DESC")
    ...
    @Query("SELECT a FROM AccountingEntry a LEFT JOIN FETCH a.createdBy WHERE YEAR(a.accountingDate) = :year AND MONTH(a.accountingDate) = :month AND a.transactionType = :transactionType ORDER BY a.accountingDate DESC, a.createdAt DESC")
    ...
    @Query("SELECT a FROM AccountingEntry a LEFT JOIN FETCH a.createdBy WHERE YEAR(a.accountingDate) = :year AND a.transactionType = :transactionType AND a.accountableName = :accountableName ORDER BY a.accountingDate DESC, a.createdAt DESC")
    ...
    @Query("SELECT a FROM AccountingEntry a LEFT JOIN FETCH a.createdBy WHERE YEAR(a.accountingDate) = :year AND MONTH(a.accountingDate) = :month AND a.transactionType = :transactionType AND a.accountableName = :accountableName ORDER BY a.accountingDate DESC, a.createdAt DESC")
